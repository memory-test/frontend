import type { routeQueryParams, routeSegments, routerPath } from './config'
...
export type TCreateUrlArgs<T extends TRouterPathValue> =
	[TExtractRouteParams<T>] extends [never]
		? [path: T, params?: undefined, queryParams?: TQueryParamsArg]
		: [path: T, params: Record<TExtractRouteParams<T>, string>, queryParams?: TQueryParamsArg]
